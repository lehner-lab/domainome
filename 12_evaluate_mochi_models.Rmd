...
if (save){ggsave(paste("output_files/Figure5e_",family,"_",fit_type,"_weight_heatmap.pdf",sep=""),height = 6, width=10)}else{
...
ggsave("output_files/ED_Figure_6a_obs_vs_predicted_allfamilies_boltzmann.pdf")
...
ggplot(predicted_vs_observed_merged_toplot[PFAM_ID=="PF00046",])+
  ...
  theme_classic()+
  theme(text=element_text(size=8))
ggsave("output_files/Figure5c_obs_vs_predicted_homeodomains_boltzmann.pdf",height=3,width = 4)
...
ggsave("output_files/Figure5b_fitness_vs_additive_trait_homeodomains_boltzmann.pdf",height=3,width = 4)
...
ggplot(summary_boltzmann_folding[N>5,])+
  ...
  xlab("Pearson's r")
ggsave("output_files/Figure_5i_byfamily_performance.pdf")
...
ggsave("output_files/ED_Figure6b_modelweights.pdf",height=11,width=18)
