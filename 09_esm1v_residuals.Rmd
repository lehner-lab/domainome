...
esm1v_predictions<-fread("analysis_files/mutated_domainome_merged_filtered_all_VEPs.txt")[,c("aa_seq","mean_esm1v_prediction_fl","mean_esm1v_prediction")]
...
for (i in seq(length(doms_for_fitting))){
  ...
  #plot residuals heatmap
   print(residuals_heatmap(subset_toplot,doms_for_fitting[i])+
           ...
           theme_classic())
   ggsave(paste0("output_files/Figure_5b_",doms_for_fitting[i],"_","esm1vres_heatmap.pdf",collapse=""))
  ...
  print(ggplot(subset_toplot)+
   ...
   ggsave(paste0("output_files/Figure_5a_",doms_for_fitting[i],"_","esm1vres.pdf",collapse=""))
