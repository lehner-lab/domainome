...
ggsave("output_files/ED_Figure_8a_site_enriched_in_epistaticmutations.pdf")
...
ggplot()+
  ...
  ylab("observed fitness")+
  xlab("predicted fitness")
ggsave("output_files/ED_Figure_8b_site_depleted_in_epistaticmutations.pdf")


ggplot(summary_by_position)+
  geom_boxplot(aes(x=core,y=log2(fet_OR),fill=core))
ggsave("output_files/ED_Figure_8c_enrichment_vs_coresurface.pdf")
...
ggsave("output_files/ED_Figure_8e_enrichment_vs_coresurface_byfamily.pdf")
...
ggsave("output_files/ED_Figure_8d_enrichment_in_epistaticmuts_core_surface_runningmedian.pdf")
...
ggsave("output_files/ED_figure_8f_core_vs_surface_getcontacts.pdf")
